...
- **Configuration examples** and usage tips
...
1. **From your AI client**: use the `request_feature` tool.
2. **GitHub Issue**: open an issue using the Feature Request template.

## Code of conduct

Be respectful. No harassment, discrimination, or personal attacks. We're here to make a useful tool — keep discussions constructive and on-topic.
