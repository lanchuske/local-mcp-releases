...
const server = new McpServer({ name: "local-mcp", version: "3.0.360" });
...
const TOOLS = [
  ...
  ["lmcp_install_upgrade", "Checks for and installs LMCP updates."],
  ["lmcp_state", "Returns a structured snapshot of the LMCP environment: server/tray/teams-proxy versions, detected AI client..."],
  ["lmcp_upgrade_diagnostics", "Returns the self-update health state: current version, last N update attempts (with errors), writability of..."],
